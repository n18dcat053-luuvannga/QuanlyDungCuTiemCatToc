...
public class SuaMatHang extends javax.swing.JFrame {
    ...
    SuaMatHang(QuanLiMatHang aThis, boolean rootPaneCheckingEnabled) {
        initComponents();         
        this.setLocationRelativeTo(null);
        qlmh = aThis;
        String day = null,month = null,year = null;
        
        MatHang mh = qlmh.getMatHang();
        this.text_idMH.setText(mh.getIdMatHang());
        this.text_idMH.setEditable(false);
        this.text_tenMH.setText(mh.getTenMatHang());
        Date date = null,date1 = null;
        try {
            date = new SimpleDateFormat("yyyy-MM-dd").parse(mh.getNSX().toString());
            date1 = new SimpleDateFormat("yyyy-MM-dd").parse(mh.getHSD().toString());
        ...
        this.text_ngaySX.setText(day);
        this.text_thangSX.setText(month);
        this.text_namSX.setText(year);
        strDate = dateFormat.format(date1);  
        day = strDate.split("-")[2];
        month = strDate.split("-")[1];
        year = strDate.split("-")[0];
        this.text_ngaySD.setText(day);
        this.text_thangSD.setText(month);
        this.text_namSD.setText(year);
    }
    ...
    private void initComponents() {
        ...
        btn_sua.setBackground(new java.awt.Color(0, 102, 0));
        ...
        getContentPane().add(btn_sua, new org.netbeans.lib.awtextra.AbsoluteConstraints(351, 245, -1, -1));
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mathang/Formthem.jpg"))); // NOI18N
        getContentPane().add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 510, 290));
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        if(choThem == 1){
            ...
            String nSX = this.text_namSX.getText()+"-"+this.text_thangSX.getText()+"-"+this.text_ngaySX.getText();
            String hSD = this.text_namSD.getText()+"-"+this.text_thangSD.getText()+"-"+this.text_ngaySD.getText();
            String update = "update mathang set tenmathang = '"+this.text_tenMH.getText()+"', ngaysanxuat = '"
                    +nSX+"', hansudung = '" +hSD+"' where idmathang = '"+this.text_idMH.getText()+"'";
            sql.updateSQL(update);
            qlmh.loadData();
            JOptionPane.showMessageDialog(rootPane, "BẠN ĐÃ SỬA THÀNH CÔNG!!!", "INFORMATION",
